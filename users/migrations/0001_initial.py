    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desired_salary', models.PositiveIntegerField(blank=True, null=True, verbose_name='Желаемая зарплата')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_skills', models.ManyToManyField(blank=True, related_name='employers', to='users.skill', verbose_name='Нужные навыки')),
